...
const BANNER_IMAGE =
  "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=280&h=257&fit=crop";
    ...
    <section className="w-full max-w-[1180px] mx-auto px-3 sm:px-4 lg:px-0">
      <div className="md:hidden rounded-xl border border-gray-200 bg-white overflow-hidden">
        <div className="border-b border-gray-200 px-3 py-3">
          <h3 className="text-sm font-bold text-gray-900">Home and outdoor</h3>
        </div>
      ...
      <div className="hidden md:flex border border-gray-200 bg-white flex-col lg:flex-row overflow-x-auto">
        <div className="w-full lg:w-[270px] lg:h-[257px] h-[180px] sm:h-[220px] relative bg-[#F5F0E8] lg:shrink-0 flex flex-col justify-between p-3 sm:p-5">
          <img
            src={BANNER_IMAGE}
